...
using ApplicationParser.Runner;
...
namespace Test
{
    ...
    public class Document : ArtifactWrapper
    {
        public string FileName { get { return this.GetValue<string>(Guid.Parse(DocumentFieldGuids.FileName)); } set { SetValue(Guid.Parse(DocumentFieldGuids.FileName), value); } }
        public Choice ContractType { get { return this.GetValue<Choice>(Guid.Parse(DocumentFieldGuids.ContractType)); } set { SetValue(Guid.Parse(DocumentFieldGuids.ContractType), value); } }
        public Choice SectionType { get { return this.GetValue<Choice>(Guid.Parse(DocumentFieldGuids.SectionType)); } set { SetValue(Guid.Parse(DocumentFieldGuids.SectionType), value); } }
        public object DocumentsAnalyzed { get { return this.GetValue<object>(Guid.Parse(DocumentFieldGuids.DocumentsAnalyzed)); } set { SetValue(Guid.Parse(DocumentFieldGuids.DocumentsAnalyzed), value); } }
        public int? SectionsIdentified { get { return this.GetValue<int?>(Guid.Parse(DocumentFieldGuids.SectionsIdentified)); } set { SetValue(Guid.Parse(DocumentFieldGuids.SectionsIdentified), value); } }
        public decimal? Confidence { get { return this.GetValue<decimal?>(Guid.Parse(DocumentFieldGuids.Confidence)); } set { SetValue(Guid.Parse(DocumentFieldGuids.Confidence), value); } }
    }

    public class ContractAnalysisJob : ArtifactWrapper
    {
        public object DocumentsAnalyzed { get { return this.GetValue<object>(Guid.Parse(ContractAnalysisJobFieldGuids.DocumentsAnalyzed)); } set { SetValue(Guid.Parse(ContractAnalysisJobFieldGuids.DocumentsAnalyzed), value); } }
        public Artifact DataSource { get { return this.GetValue<Artifact>(Guid.Parse(ContractAnalysisJobFieldGuids.DataSource)); } set { SetValue(Guid.Parse(ContractAnalysisJobFieldGuids.DataSource), value); } }
        public Choice JobType { get { return this.GetValue<Choice>(Guid.Parse(ContractAnalysisJobFieldGuids.JobType)); } set { SetValue(Guid.Parse(ContractAnalysisJobFieldGuids.JobType), value); } }
        public int? ContractsAnalyzed { get { return this.GetValue<int?>(Guid.Parse(ContractAnalysisJobFieldGuids.ContractsAnalyzed)); } set { SetValue(Guid.Parse(ContractAnalysisJobFieldGuids.ContractsAnalyzed), value); } }
    }

    public class HeretikConfiguration : ArtifactWrapper
    {
    }
